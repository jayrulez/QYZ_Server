...
import multistory.MultiSotryTeam;
...
public class GAddMultiMatch extends __GAddMultiMatch__ {
	...
	protected void process() {
        MultiSotryTeam team = new MultiSotryTeam(MultiSotryTeam.creatMembers(members), (int)gid, MutilStoryModule.MULTI_STORY_MATCH_NUMS);
        MutilStoryModule.multiStoryManager.add(team);	}
