...
public final class Helper {
	...
	/**
	 * 重新分配内存。
	 * 当 buffer 的剩余空间不足increment时，扩展buffer内存。
	 * 分配内存的时候按 roundup 方式增长。
	 * 
	 ...
	 *
	 * jdk的实现都有此检查，如果我们的实现只是调用jdk，就不用特别检查。
	 * 只有我们需要分批填写dst，为了避免前面的填写成功，而后面填写失败，
	 ...
	 * 
	 * @throws IOError if addr is not a ip4 address
	 */
