...
public final class WeakHashSet<K> {
    ...
    /**
     * Constructs a new, empty <tt>WeakHashSet</tt> with the given initial
    ...
    /**
     * Returns the key stored in the set
     * NOT THREAD SAFE
     *
     * @see #add(Object)
     */
     ...
     * unchanged and returns the old value.
     *
    ...
    /**
     * The entries in this hash set extend WeakReference 
