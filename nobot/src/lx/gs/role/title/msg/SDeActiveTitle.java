...
abstract class __SDeActiveTitle__ extends xio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class SDeActiveTitle extends __SDeActiveTitle__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6557908;
	...
	public SDeActiveTitle() {
	}

	public SDeActiveTitle(int _titlekey_, int _titletype_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SDeActiveTitle) {
			SDeActiveTitle _o_ = (SDeActiveTitle)_o1_;
	...
	public int compareTo(SDeActiveTitle _o_) {
