...
abstract class __SWashAccessory__ extends xio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class SWashAccessory extends __SWashAccessory__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6574606;
	...
	public SWashAccessory() {
		newprop = new lx.gs.equip.PropInfo();
	}

	public SWashAccessory(int _bagtype_, int _pos_, int _oldpropindex_, lx.gs.equip.PropInfo _newprop_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SWashAccessory) {
			SWashAccessory _o_ = (SWashAccessory)_o1_;
