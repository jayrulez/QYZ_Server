...
abstract class __SUnBlackFriend__ extends xio.Protocol { }
...
public class SUnBlackFriend extends __SUnBlackFriend__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6553918;
	...
	public SUnBlackFriend() {
		okroleidlist = new java.util.ArrayList<Long>();
	}

	public SUnBlackFriend(java.util.ArrayList<Long> _okroleidlist_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SUnBlackFriend) {
			SUnBlackFriend _o_ = (SUnBlackFriend)_o1_;
