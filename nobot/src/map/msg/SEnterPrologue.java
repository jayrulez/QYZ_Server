...
import lx.gs.map.msg.CLeaveMap;

// {{{ RPCGEN_IMPORT_BEGIN
// {{{ DO NOT EDIT THIS

abstract class __SEnterPrologue__ extends xio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class SEnterPrologue extends __SEnterPrologue__ {
	@Override
	protected void process() {
        new CLeaveMap().send(getConnection());
	}

	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6698890;
	...
	public SEnterPrologue(long _id_, int _ectypeid_, long _remaintime_, int _remainrevivecount_, java.util.HashMap<Integer,Integer> _enviroments_, java.util.ArrayList<map.msg.LayoutInfo> _openlayouts_, java.util.ArrayList<Integer> _activeactions_) {
		this.id = _id_;
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SEnterPrologue) {
			SEnterPrologue _o_ = (SEnterPrologue)_o1_;
