...
abstract class __SEnterPlainStoryEctype__ extends xio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class SEnterPlainStoryEctype extends __SEnterPlainStoryEctype__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6695571;
	...
	public SEnterPlainStoryEctype(long _id_, int _ectypeid_, long _remaintime_, int _remainrevivecount_, java.util.HashMap<Integer,Integer> _enviroments_, java.util.ArrayList<map.msg.LayoutInfo> _openlayouts_, java.util.ArrayList<Integer> _activeactions_) {
		this.id = _id_;
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SEnterPlainStoryEctype) {
			SEnterPlainStoryEctype _o_ = (SEnterPlainStoryEctype)_o1_;
