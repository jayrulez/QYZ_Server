...
abstract class __SEnterArenaEctype__ extends xio.Protocol { }
...
public class SEnterArenaEctype extends __SEnterArenaEctype__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6710442;
	...
	public SEnterArenaEctype() {
	}

	public SEnterArenaEctype(long _id_, int _ectypeid_, int _state_, long _remaintime_) {
		this.id = _id_;
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SEnterArenaEctype) {
			SEnterArenaEctype _o_ = (SEnterArenaEctype)_o1_;
	...
	public int compareTo(SEnterArenaEctype _o_) {
