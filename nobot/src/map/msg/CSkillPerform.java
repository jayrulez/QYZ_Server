...
abstract class __CSkillPerform__ extends xio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class CSkillPerform extends __CSkillPerform__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6685189;
	...
	public CSkillPerform() {
		direction = new map.msg.Vector3();
	}

	public CSkillPerform(int _skillid_, long _targetid_, map.msg.Vector3 _direction_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof CSkillPerform) {
			CSkillPerform _o_ = (CSkillPerform)_o1_;
