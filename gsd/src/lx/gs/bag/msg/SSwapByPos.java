...
abstract class __SSwapByPos__ extends xio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class SSwapByPos extends __SSwapByPos__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6574945;
	...
	public SSwapByPos(int _bagtype1_, int _pos1_, int _bagtype2_, int _pos2_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SSwapByPos) {
			SSwapByPos _o_ = (SSwapByPos)_o1_;
	...
	public int compareTo(SSwapByPos _o_) {
