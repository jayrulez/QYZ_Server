...
abstract class __SSyncItems__ extends xio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class SSyncItems extends __SSyncItems__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6564788;
	...
	public SSyncItems(int _bagtype_, java.util.HashMap<Integer,com.goldhuman.Common.Octets> _iteminfo_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SSyncItems) {
			SSyncItems _o_ = (SSyncItems)_o1_;
