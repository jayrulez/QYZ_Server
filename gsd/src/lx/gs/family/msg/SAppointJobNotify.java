...
abstract class __SAppointJobNotify__ extends xio.Protocol { }
...
public class SAppointJobNotify extends __SAppointJobNotify__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6564581;
	...
	public SAppointJobNotify() {
		operator = new lx.gs.family.msg.FamilyMember();
		member = new lx.gs.family.msg.FamilyMember();
	}

	public SAppointJobNotify(lx.gs.family.msg.FamilyMember _operator_, lx.gs.family.msg.FamilyMember _member_, int _jobid_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SAppointJobNotify) {
			SAppointJobNotify _o_ = (SAppointJobNotify)_o1_;
