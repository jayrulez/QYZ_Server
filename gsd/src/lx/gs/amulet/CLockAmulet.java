...
abstract class __CLockAmulet__ extends xio.Protocol { }
...
public class CLockAmulet extends lx.gs.amulet.__CLockAmulet__ {
	@Override
	protected void process() {
		new AProcedure<CLockAmulet>(this) {
			@Override
			protected boolean doProcess() throws Exception {
				...
				info.getPagemap().get(pageid).getPropmap()
						.get(amuletid).setIslock(Const.TRUE);

				response(new SLockAmulet(pageid, amuletid));
				return true;
			}
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6573456;
	...
	public CLockAmulet(int _pageid_, int _amuletid_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof CLockAmulet) {
			CLockAmulet _o_ = (CLockAmulet)_o1_;
	...
	public int compareTo(CLockAmulet _o_) {
