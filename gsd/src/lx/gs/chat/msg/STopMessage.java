...
abstract class __STopMessage__ extends xio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class STopMessage extends __STopMessage__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6568501;
	...
	public STopMessage(lx.gs.chat.msg.Content _content_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof STopMessage) {
			STopMessage _o_ = (STopMessage)_o1_;
