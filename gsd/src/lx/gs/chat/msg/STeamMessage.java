...
abstract class __STeamMessage__ extends xio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class STeamMessage extends __STeamMessage__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6554005;
	...
	public STeamMessage(lx.gs.chat.msg.Content _content_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof STeamMessage) {
			STeamMessage _o_ = (STeamMessage)_o1_;
