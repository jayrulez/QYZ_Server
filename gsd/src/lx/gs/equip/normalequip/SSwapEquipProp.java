...
abstract class __SSwapEquipProp__ extends xio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class SSwapEquipProp extends lx.gs.equip.normalequip.__SSwapEquipProp__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6583918;
	...
	public SSwapEquipProp() {
	}

	public SSwapEquipProp(int _bagtype1_, int _pos1_, int _bagtype2_, int _pos2_, int _isswapanneal_, int _isswapperfuse_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SSwapEquipProp) {
			SSwapEquipProp _o_ = (SSwapEquipProp)_o1_;
	...
	public int compareTo(SSwapEquipProp _o_) {
