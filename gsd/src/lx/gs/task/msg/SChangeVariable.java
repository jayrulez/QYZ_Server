...
abstract class __SChangeVariable__ extends xio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class SChangeVariable extends __SChangeVariable__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6554311;
	...
	public SChangeVariable() {
		changes = new java.util.HashMap<Integer,Integer>();
		removes = new java.util.ArrayList<Integer>();
	}

	public SChangeVariable(java.util.HashMap<Integer,Integer> _changes_, java.util.ArrayList<Integer> _removes_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SChangeVariable) {
			SChangeVariable _o_ = (SChangeVariable)_o1_;
