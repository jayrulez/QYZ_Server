...
import lx.gs.map.msg.SMatchTeamFightSucc;
	...
	protected void process() {
        new xdb.Procedure() {
            ...
            protected boolean process() {
                ...
                final SMatchTeamFightSucc re = new SMatchTeamFightSucc(countDown, team1, team2);
                for(long roleid : myteammembers) {
                    FMap.succMatch(roleid);
                }
                xdb.Transaction.tsendWhileCommit(myteammembers, re);
