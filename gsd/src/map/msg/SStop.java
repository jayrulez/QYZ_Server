...
abstract class __SStop__ extends xio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class SStop extends __SStop__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6684774;
	...
	public SStop(map.msg.Vector3 _position_, map.msg.Vector3 _orient_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SStop) {
			SStop _o_ = (SStop)_o1_;
