...
abstract class __SEnterMultiStoryEctype__ extends xio.Protocol { }
...
public class SEnterMultiStoryEctype extends __SEnterMultiStoryEctype__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6707575;
	...
	public SEnterMultiStoryEctype(long _id_, int _ectypeid_, long _remaintime_, int _remainrevivecount_, java.util.HashMap<Integer,Integer> _enviroments_, java.util.ArrayList<map.msg.LayoutInfo> _openlayouts_, java.util.ArrayList<Integer> _activeactions_) {
		this.id = _id_;
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SEnterMultiStoryEctype) {
			SEnterMultiStoryEctype _o_ = (SEnterMultiStoryEctype)_o1_;
