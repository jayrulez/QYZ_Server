...
abstract class __SEnterHuiWu__ extends xio.Protocol { }
...
public class SEnterHuiWu extends __SEnterHuiWu__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6714079;
	...
	public SEnterHuiWu(long _id_, int _ectypeid_, int _state_, long _remaintime_) {
		this.id = _id_;
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SEnterHuiWu) {
			SEnterHuiWu _o_ = (SEnterHuiWu)_o1_;
	...
	public int compareTo(SEnterHuiWu _o_) {
