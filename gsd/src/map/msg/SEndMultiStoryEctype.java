...
abstract class __SEndMultiStoryEctype__ extends xio.Protocol { }
...
public class SEndMultiStoryEctype extends __SEndMultiStoryEctype__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6712286;
	...
	public SEndMultiStoryEctype() {
		bonus = new map.msg.Bonus();
	}

	public SEndMultiStoryEctype(int _errcode_, int _ectypeid_, int _star_, map.msg.Bonus _bonus_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SEndMultiStoryEctype) {
			SEndMultiStoryEctype _o_ = (SEndMultiStoryEctype)_o1_;
