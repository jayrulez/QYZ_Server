...
abstract class __SCurveFlyBegin__ extends xio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class SCurveFlyBegin extends __SCurveFlyBegin__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6714969;
	...
	public SCurveFlyBegin() {
		curposition = new map.msg.Vector3();
		dstposition = new map.msg.Vector3();
	}

	public SCurveFlyBegin(int _portalid_, map.msg.Vector3 _curposition_, map.msg.Vector3 _dstposition_, int _curveid_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SCurveFlyBegin) {
			SCurveFlyBegin _o_ = (SCurveFlyBegin)_o1_;
