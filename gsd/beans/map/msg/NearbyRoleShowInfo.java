...
public class NearbyRoleShowInfo implements Marshal {
	public long roleid;
	public int serverid;
	...
	public NearbyRoleShowInfo() {
		name = "";
	}

	public NearbyRoleShowInfo(long _roleid_, int _serverid_, java.lang.String _name_, int _profession_, int _gender_, int _level_, int _viplevel_, int _combatpower_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof NearbyRoleShowInfo) {
			NearbyRoleShowInfo _o_ = (NearbyRoleShowInfo)_o1_;
