...
public class RoleShowInfo3 implements Marshal {
	public long roleid;
	public int serverid;
	...
	public RoleShowInfo3(long _roleid_, int _serverid_, java.lang.String _name_, int _profession_, int _gender_, int _level_, int _viplevel_, int _combatpower_, java.util.ArrayList<map.msg.EquipBrief> _equips_, int _dressid_, int _title_, java.lang.String _familyname_, int _familyjob_, int _familylevel_, java.lang.String _lovername_, java.util.HashMap<Integer,Float> _fightattrs_, long _lastonlinetime_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof RoleShowInfo3) {
			RoleShowInfo3 _o_ = (RoleShowInfo3)_o1_;
