...
abstract class __SEnterDailyEctype__ extends xio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class SEnterDailyEctype extends __SEnterDailyEctype__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 6716058;
	...
	public long id;
	public int ectypeid;
	public int waveindex; // 当前是第几波怪, 从0开始
	public long remaintime;

	public SEnterDailyEctype() {
	}

	public SEnterDailyEctype(long _id_, int _ectypeid_, int _waveindex_, long _remaintime_) {
		this.id = _id_;
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SEnterDailyEctype) {
			SEnterDailyEctype _o_ = (SEnterDailyEctype)_o1_;
	...
	public int compareTo(SEnterDailyEctype _o_) {
